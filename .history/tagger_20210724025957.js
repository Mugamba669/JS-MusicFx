...
var url = "../../Music/Desiigner - Tiimmy Turner (Official Audio).mp3";
             ...
             case 6:
              ...
              case 7:
                editor.onchange = function(e){
                  ...
                  Tags.image.mime = data.webkitRelativePath;
                  Tags.image.type = data.type;

                    var reader = new FileReader();
                    reader.onload = (e)=>{
                      Tags.image.imageBuffer = e.target.result;
                      console.log(Tags)
                      // document.body.style.backgroundImage = "url("+Tags.image.imageBuffer+")";
                    }
