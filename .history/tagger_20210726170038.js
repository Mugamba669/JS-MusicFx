            ...
            switch (index) {
              case 0:
                btn.onclick = function(){
                  //  MenuItem.once() role:'close'
                }
                break;
    
                case 1:
                  btn.onclick = function(){
                    NodeID3.Promise.write(that.Tags,that.url)
                  }
                  break;
...
exports.module = AudioEditor;
// const  AudioEditor =  require('./tagger.js');
var url = "../../Music/Goodlyfe - Ngamba.mp3";

    var tagger = new AudioEditor("../../Music/Goodlyfe - Ngamba.mp3");
    tagger.getEditor();
    console.log(tagger)
// var url = "../../Music/Goodlyfe - Ngamba.mp3";
// var _ = (all)=>{
...
fs.readFile('./info.json',(error,data)=>{
  if (error) {
    ...
    console.log(JSON.parse(data).me)
  }
})