    ...
    getPlaylist(selector){
       ...
       $(selector).on("change",function(e){
        ...
        console.log(($('.title').text()).length)
            ...
            var cover = $('<img/>').attr('src','../images/pAudio.jpeg').css({"width":"40px","height":"40px","border-radius":"50%"});
               $("<p></p>").text("  "+data.name).addClass('list-tile').prepend(cover).append("<hr/>").appendTo(".list").click(function(){
                   $("#play").hide();
                    $("#pause").show();
       ...
       $('.plist').click(function(){ $(this).addClass('w3-hide');});
