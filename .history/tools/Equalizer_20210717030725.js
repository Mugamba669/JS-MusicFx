          ...
          var playlist = Object.values(files)
           playlist.map((data,index)=>{
            ...
            ID3.loadTags(url, () => {
               ...
               var cover = $('<img/>').attr('src', that.base64Cover(image)).css({"width":"40px","height":"40px","border-radius":"50%","margin":"25px"});
           
               $("<p></p>").text("  "+that.listTracks(title)).addClass('list-tile').prepend(cover).append("<hr/>").appendTo(".list").click(function(){
