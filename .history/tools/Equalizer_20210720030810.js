...
class Equalizer {
    ...
    //    show pop up
        ...
        function showLoader(progress){
            ...
            var output = (progress/(playlist.length-1));
            $('.text-output').text(progress);
             that._('.progress-loader').style.width = progress+"%";
        }
        function hideLoader(){
            $('.loader-container').hide();
       ...
       $(selector).on("change",function(e){
        ...
        $('.total').text(index+1);
            ...
            (index < (playlist.length -1))?showLoader(index):hideLoader();
