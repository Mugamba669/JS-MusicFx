...
if (that.fileInfo.type(data) == "audio/mpeg") {
    ...
    function showNextTrack(url,data){
        ID3.loadTags(url, () => {
            ...
            let cover = $("<img/>").props("src","data:image"+image.format+";base64,"+window.btoa(base64String)).addClass('coverArt'); 
            let defaultCover = $("<img/>").attr("src","../images/pAudio.jpeg").addClass('coverArt');
