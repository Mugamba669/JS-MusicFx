...
if (that.fileInfo.type(data) == "audio/mpeg") {
        ...
        $(".lyrics-track").text(that.listTracks(title,data))
        ...
        that.audio.onended =  ()=>{ 
            ...
            if((next +1) > playlist.length){
                ...
                $(".tt-T").text(`${(playlist.length)}`);
                    ...
                    $(".lyrics-track").text(that.listTracks(url,arrayList[next]))
        ...
        $('#nextTrack').show().on('click',function(){
            ...
            if((next + 1) > playlist.length){
                ...
                var url = that.srcURL(arrayList[next]);
                 ...
                 $(".lyrics-track").text("Lyrics - "+that.listTracks(url,arrayList[next]))
            }
        });
        ...
        $('#prevTrack').show().on('click',function(){
            ...
            if(prev < 0){
                ...
                $(".lyrics-track").text("Lyrics - "+that.listTracks(url,arrayList[prev]))
